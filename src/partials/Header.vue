<template>
  <header class="absolute w-full z-30" :class="{ 'dark': mode !== 'light' }">
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="flex items-center justify-between h-16 md:h-20">
        ...
        <div class="shrink-0 mr-4">
          <!-- Logo -->
          <router-link class="block text-blue-600 transition duration-150 ease-in-out" to="/" aria-label="Cruip">
        ...
        <nav class="hidden md:flex md:grow">
          ...
          <ul class="flex grow justify-start flex-wrap items-center">
            <li>
              <router-link to="/pricing" class="font-medium text-slate-800 hover:text-blue-600 dark:text-slate-400 dark:hover:text-blue-600 px-3 lg:px-5 py-2 flex items-center transition duration-150 ease-in-out">Pricing</router-link>
            </li>
            <li>
              <router-link to="/about" class="font-medium text-slate-800 hover:text-blue-600 dark:text-slate-400 dark:hover:text-blue-600 px-3 lg:px-5 py-2 flex items-center transition duration-150 ease-in-out">About</router-link>
            </li>
            <li>
              <router-link to="/blog" class="font-medium text-slate-800 hover:text-blue-600 dark:text-slate-400 dark:hover:text-blue-600 px-3 lg:px-5 py-2 flex items-center transition duration-150 ease-in-out">Blog</router-link>
            </li>
            <li>
              <router-link to="/wall-of-love" class="font-medium text-slate-800 hover:text-blue-600 dark:text-slate-400 dark:hover:text-blue-600 px-3 lg:px-5 py-2 flex items-center transition duration-150 ease-in-out">Wall of Love</router-link>
            </li>
            <!-- 1st level: hover -->
          ...
          <ul class="flex grow justify-end flex-wrap items-center">
            <li>
              <router-link to="/signin" class="font-medium text-slate-800 hover:text-blue-600 dark:text-slate-400 dark:hover:text-blue-600 px-3 lg:px-5 py-2 flex items-center transition duration-150 ease-in-out">Sign in</router-link>
            </li>
            <li>
